...
Public Class rptSanadNaghdi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tarabari.rptSanadNaghdi.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_TotalValueHoroofi() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptSanadNaghdi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSanadNaghdi = New rptSanadNaghdi
        rpt.Site = Me.Site
        Return rpt
    End Function
