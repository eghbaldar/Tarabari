...
Public Class rptPardakhtFactorPrice
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPardakhtFactorPrice.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tarabari.rptPardakhtFactorPrice.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPardakhtFactorPrice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPardakhtFactorPrice = New rptPardakhtFactorPrice
        rpt.Site = Me.Site
        Return rpt
    End Function
